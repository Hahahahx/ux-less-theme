...
function changeLessVars(params) {
    return isSetConfig(function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield compile_less_1.compileLess(indexPath, path.resolve(option.outputDir, params.compileAntd ? "theme-antd.css" : "theme.css"), !params.compileAntd, params.vars, params.compileAntd ? filterData(params.theme) : undefined);
            return result;
        });
    });
}
